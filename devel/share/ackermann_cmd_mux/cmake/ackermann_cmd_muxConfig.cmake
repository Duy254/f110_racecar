...
if("TRUE" STREQUAL "TRUE")
  set(ackermann_cmd_mux_SOURCE_PREFIX /home/nvidia/f110_ws/src/system/racecar/ackermann_cmd_mux)
  set(ackermann_cmd_mux_DEVEL_PREFIX /home/nvidia/f110_ws/devel)
  ...
  set(ackermann_cmd_mux_INSTALL_PREFIX /home/nvidia/f110_ws/install)
...
if(NOT "/home/nvidia/f110_ws/devel/include;/home/nvidia/f110_ws/src/system/racecar/ackermann_cmd_mux/include " STREQUAL " ")
  set(ackermann_cmd_mux_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/f110_ws/devel/include;/home/nvidia/f110_ws/src/system/racecar/ackermann_cmd_mux/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ackermann_cmd_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/f110_ws/src/system/racecar/ackermann_cmd_mux/${idir}'.  ${_report}")
    endif()
