...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/nvidia/f110_ws/src/labs/localization)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/f110_ws/src/labs/localization/${idir}'.  ${_report}")
    endif()
