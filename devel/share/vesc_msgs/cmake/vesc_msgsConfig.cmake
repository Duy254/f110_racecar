...
if("TRUE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/nvidia/f110_ws/src/system/vesc/vesc_msgs)
  set(vesc_msgs_DEVEL_PREFIX /home/nvidia/f110_ws/devel)
  ...
  set(vesc_msgs_INSTALL_PREFIX /home/nvidia/f110_ws/install)
...
if(NOT "/home/nvidia/f110_ws/devel/include " STREQUAL " ")
  set(vesc_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/f110_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/f110_ws/src/system/vesc/vesc_msgs/${idir}'.  ${_report}")
    endif()
