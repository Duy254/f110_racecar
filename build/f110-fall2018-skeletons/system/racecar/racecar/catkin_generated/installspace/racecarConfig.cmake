...
if("FALSE" STREQUAL "TRUE")
  set(racecar_SOURCE_PREFIX /home/nvidia/f110_ws/src/f110-fall2018-skeletons/system/racecar/racecar)
  set(racecar_DEVEL_PREFIX /home/nvidia/f110_ws/devel)
  set(racecar_INSTALL_PREFIX "")
  set(racecar_PREFIX ${racecar_DEVEL_PREFIX})
else()
  set(racecar_SOURCE_PREFIX "")
  set(racecar_DEVEL_PREFIX "")
  set(racecar_INSTALL_PREFIX /home/nvidia/f110_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'racecar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/f110_ws/install/${idir}'.  ${_report}")
    endif()
