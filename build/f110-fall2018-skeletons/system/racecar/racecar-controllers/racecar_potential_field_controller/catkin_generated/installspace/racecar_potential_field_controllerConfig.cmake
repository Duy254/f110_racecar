...
if("FALSE" STREQUAL "TRUE")
  set(racecar_potential_field_controller_SOURCE_PREFIX /home/nvidia/f110_ws/src/f110-fall2018-skeletons/system/racecar/racecar-controllers/racecar_potential_field_controller)
...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'racecar_potential_field_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/f110_ws/install/${idir}'.  ${_report}")
    endif()
