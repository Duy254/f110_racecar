...
if("FALSE" STREQUAL "TRUE")
  set(ackermann_cmd_mux_SOURCE_PREFIX /home/nvidia/f110_ws/src/f110-fall2018-skeletons/system/racecar/ackermann_cmd_mux)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ackermann_cmd_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/f110_ws/install/${idir}'.  ${_report}")
    endif()
