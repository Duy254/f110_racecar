...
if("FALSE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/nvidia/f110_ws/src/f110-fall2018-skeletons/system/vesc/vesc_msgs)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/f110_ws/install/${idir}'.  ${_report}")
    endif()
