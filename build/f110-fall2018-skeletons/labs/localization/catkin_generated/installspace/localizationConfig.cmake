...
if("FALSE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/nvidia/f110_ws/src/f110-fall2018-skeletons/labs/localization)
  set(localization_DEVEL_PREFIX /home/nvidia/f110_ws/devel)
  ...
  set(localization_INSTALL_PREFIX /home/nvidia/f110_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/f110_ws/install/${idir}'.  ${_report}")
    endif()
