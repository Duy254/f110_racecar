...
if(NOT "include;/usr/include/suitesparse;/opt/ros/kinetic/include/g2o " STREQUAL " ")
  set(teb_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/suitesparse;/opt/ros/kinetic/include/g2o")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teb_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/f110_ws/install/${idir}'.  ${_report}")
    endif()
